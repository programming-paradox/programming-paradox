...
I am an enthusiastic student with a strong drive to advance society through innovative technology and foster a community of creative individuals. I possess expertise in several programming languages, including Python (Django, Tensorflow, Flask, OpenCV, etc.), C++, and Julia. My passion for artificial intelligence is unparalleled, as I am committed to enhancing the daily lives of individuals by collaborating with AI to increase efficiency.
...
<div>
  <span><li>🔭 I’m currently working on ... Python, Solidity, Blockchian, React, Node</li></span>
<span><li>🌱 I’m currently learning ... Lot's of thing (Blockchian, React, Nodejs, JavaScript/TypeScript)</li></span>
